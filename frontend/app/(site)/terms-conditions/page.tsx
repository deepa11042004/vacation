      ...
      <div className="max-w-4xl mx-auto bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-12 lg:p-16">
        ...
        <div className="space-y-8 text-slate-600 leading-relaxed">
          <section className="space-y-4">
            ...
            <p>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy, and Terms of Use for access or usage of the domain name www.(&apos;Website&apos;), including the related mobile site and mobile application (hereinafter referred to as &apos;Platform&apos;).
            </p>
            <p>
              The Platform is owned by <strong>ROSEWOOD WORLDWIDE TRAVEL PRIVATE LIMITED</strong>, a company incorporated under the Companies Act, 1956 with its registered office at 20 2202 ATS DOLCE ZETA 1, Noida ZETA 1, Greater Noida, India (hereinafter referred to as &apos;Platform Owner&apos;, we, us, our).
            </p>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-800 font-marcellus mt-12 mb-6">User Agreement</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-800 font-marcellus mt-12 mb-6">Terms of Use</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-800 font-marcellus mt-12 mb-6">Governing Law and Jurisdiction</h2>
            <p>
            ...
            <p>
              All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Greater Noida, Uttar Pradesh.
            </p>
          </section>

          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-slate-800 font-marcellus mt-12 mb-6">Contact Information</h2>
            <p>
              All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website.
            </p>
            <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 mt-6">
              <p className="font-semibold text-blue-900">Product</p>
              <p className="text-blue-800 mt-1">Our Holiday package category starts from Rs. 40,000/- to 3,00,000/-</p>
            </div>
          </section>
        </div>
      </div>
