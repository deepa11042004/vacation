...
export const metadata = {
  title: "Terms & Conditions | MANDARIN WORLDWIDE",
  description:
    "Terms and Conditions for MANDARIN WORLDWIDE (Mandarin Worldwide Travel Private Limited).",
};
        ...
        <div className="space-y-8 text-slate-600 leading-relaxed">
          <section className="space-y-4">
            ...
            <p>
              ...
              of the domain name www.(&apos;Website&apos;), including the
              related mobile site and mobile application (hereinafter referred
              to as &apos;Platform&apos;).
            </p>
            <p>
              The Platform is owned by{" "}
              <strong>MANDARIN WORLDWIDE TRAVEL PRIVATE LIMITED</strong>, a
              company incorporated under the Companies Act, 1956 with its
              registered office at 20 2202 ATS DOLCE ZETA 1, Noida ZETA 1,
              Greater Noida, India (hereinafter referred to as &apos;Platform
              Owner&apos;, we, us, our).
            </p>
            <p>
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              requires ‘you’, &apos;your&apos; or ‘user’ shall mean any natural
          ...
          <section className="space-y-4">
            ...
            <div className="bg-blue-50/50 p-6 rounded-2xl border border-blue-100 mt-6">
              ...
              <p className="text-blue-800 mt-1">
                Our Holiday package category starts from Rs. 40,000/- to
                3,00,000/-
              </p>
            </div>
          </section>
